...
image_path = "/Users/shradhasharma/Downloads/face.jpg"  # Path to the input image (string)
shape_predictor_path = "/Users/shradhasharma/Downloads/shape_predictor_68_face_landmarks.dat"  # Path to the shape predictor model (string)
...
for num in arr:
    ...
    for face in faces:
        ...
        cv2.imwrite(f"eyes{num}.jpg", cutImage)
